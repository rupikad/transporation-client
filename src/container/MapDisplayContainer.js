  ...
  render() {
    ...
    return (
      <div className={styles.map}>
        ...
        {directions.duration && <><p>{directions.duration.text}</p> <p>{distanceText}</p></>}
        {directions.distance && <p>Trimet Bus Distance: 5.1 mi</p>}
        {directions.distance && <p>Trimet Bus Duration: 21 min</p>}
        <MapDisplayContainer
          fetch={fetch}
          info={info}
